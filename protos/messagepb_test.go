...
func TestNeighborsProto(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedNeighbors(popr, false)
	dAtA, err := github_com_gogo_protobuf_proto.Marshal(p)
	if err != nil {
		t.Fatalf("seed = %d, err = %v", seed, err)
	}
...
func TestNeighborsMarshalTo(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedNeighbors(popr, false)
	size := p.Size()
...
func TestStopRemoteNodeProto(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedStopRemoteNode(popr, false)
	dAtA, err := github_com_gogo_protobuf_proto.Marshal(p)
	if err != nil {
		t.Fatalf("seed = %d, err = %v", seed, err)
	}
...
func TestStopRemoteNodeMarshalTo(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedStopRemoteNode(popr, false)
	size := p.Size()
...
func TestConnectNodeProto(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedConnectNode(popr, false)
	dAtA, err := github_com_gogo_protobuf_proto.Marshal(p)
	if err != nil {
		t.Fatalf("seed = %d, err = %v", seed, err)
	}
...
func TestConnectNodeMarshalTo(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedConnectNode(popr, false)
	size := p.Size()
...
func TestNeighborsJSON(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedNeighbors(popr, true)
	marshaler := github_com_gogo_protobuf_jsonpb.Marshaler{}
	jsondata, err := marshaler.MarshalToString(p)
	if err != nil {
		t.Fatalf("seed = %d, err = %v", seed, err)
...
func TestStopRemoteNodeJSON(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedStopRemoteNode(popr, true)
	marshaler := github_com_gogo_protobuf_jsonpb.Marshaler{}
	jsondata, err := marshaler.MarshalToString(p)
	if err != nil {
		t.Fatalf("seed = %d, err = %v", seed, err)
...
func TestConnectNodeJSON(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedConnectNode(popr, true)
	marshaler := github_com_gogo_protobuf_jsonpb.Marshaler{}
	jsondata, err := marshaler.MarshalToString(p)
	if err != nil {
		t.Fatalf("seed = %d, err = %v", seed, err)
...
func TestNeighborsProtoText(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedNeighbors(popr, true)
	dAtA := github_com_gogo_protobuf_proto.MarshalTextString(p)
...
func TestNeighborsProtoCompactText(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedNeighbors(popr, true)
	dAtA := github_com_gogo_protobuf_proto.CompactTextString(p)
...
func TestStopRemoteNodeProtoText(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedStopRemoteNode(popr, true)
	dAtA := github_com_gogo_protobuf_proto.MarshalTextString(p)
...
func TestStopRemoteNodeProtoCompactText(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedStopRemoteNode(popr, true)
	dAtA := github_com_gogo_protobuf_proto.CompactTextString(p)
...
func TestConnectNodeProtoText(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedConnectNode(popr, true)
	dAtA := github_com_gogo_protobuf_proto.MarshalTextString(p)
...
func TestConnectNodeProtoCompactText(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedConnectNode(popr, true)
	dAtA := github_com_gogo_protobuf_proto.CompactTextString(p)
...
func TestNeighborsGoString(t *testing.T) {
	popr := math_rand.New(math_rand.NewSource(time.Now().UnixNano()))
	p := NewPopulatedNeighbors(popr, false)
	s1 := p.GoString()
	s2 := fmt.Sprintf("%#v", p)
...
func TestStopRemoteNodeGoString(t *testing.T) {
	popr := math_rand.New(math_rand.NewSource(time.Now().UnixNano()))
	p := NewPopulatedStopRemoteNode(popr, false)
	s1 := p.GoString()
	s2 := fmt.Sprintf("%#v", p)
...
func TestConnectNodeGoString(t *testing.T) {
	popr := math_rand.New(math_rand.NewSource(time.Now().UnixNano()))
	p := NewPopulatedConnectNode(popr, false)
	s1 := p.GoString()
	s2 := fmt.Sprintf("%#v", p)
...
func TestNeighborsSize(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedNeighbors(popr, true)
	size2 := github_com_gogo_protobuf_proto.Size(p)
...
func TestStopRemoteNodeSize(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedStopRemoteNode(popr, true)
	size2 := github_com_gogo_protobuf_proto.Size(p)
...
func TestConnectNodeSize(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedConnectNode(popr, true)
	size2 := github_com_gogo_protobuf_proto.Size(p)
...
func TestNeighborsStringer(t *testing.T) {
	popr := math_rand.New(math_rand.NewSource(time.Now().UnixNano()))
	p := NewPopulatedNeighbors(popr, false)
	s1 := p.String()
	s2 := fmt.Sprintf("%v", p)
...
func TestStopRemoteNodeStringer(t *testing.T) {
	popr := math_rand.New(math_rand.NewSource(time.Now().UnixNano()))
	p := NewPopulatedStopRemoteNode(popr, false)
	s1 := p.String()
	s2 := fmt.Sprintf("%v", p)
...
func TestConnectNodeStringer(t *testing.T) {
	popr := math_rand.New(math_rand.NewSource(time.Now().UnixNano()))
	p := NewPopulatedConnectNode(popr, false)
	s1 := p.String()
	s2 := fmt.Sprintf("%v", p)
